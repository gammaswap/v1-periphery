        ...
        describe('transfers', function () {
            ...
            const shouldTransferTokensByUsers = function (transferFunction: any) {
                ...
                context('when the sender is not authorized for the token id', function () {
                    it('reverts', async function () {
                        await expect(transferFunction.call(this, this.owner.address, this.other.address, tokenId, { from: this.other.address })).to.be.revertedWith("ERC721: caller is not token owner or approved");
